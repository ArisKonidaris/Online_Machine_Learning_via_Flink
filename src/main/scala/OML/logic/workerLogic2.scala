...
class workerLogic2 extends CoFlatMapFunction[LearningMessage, LearningMessage, (Int, Int, LearningParameters)] {
  ...
  override def flatMap1(input: LearningMessage, out: Collector[(Int, Int, LearningParameters)]): Unit = {
    input match {
  ...
  override def flatMap2(input: LearningMessage, out: Collector[(Int, Int, LearningParameters)]): Unit = {
    input match {
